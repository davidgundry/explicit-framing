...
* **moves_correct_form_last16** - number of moves with the correct form (see moves_correct_form) out of last 15 moves
* **grammatical_moves_last16_idealised** - number of grammatical moves out of last 15, if against idealised grammar
* **proportion_of_valid_data_last16_idealised** - % grammatical (by idealised grammar) moves out of last 15 moves
* **proportion_of_valid_data_providing_mechanic_actuations_last16_idealised** - % grammatical (by idealised grammar) out of last 15 moves of correct form
