...
def correlation(df):
    ...
    print("(Correlation, p)")
    print("Pearson's r", pearsonr(df['play_framing'], df['proportion_of_valid_data_last16_idealised']))
    print("Spearman's rho", spearmanr(df['play_framing'], df['proportion_of_valid_data_last16_idealised']))
    print("Degrees of freedom", len(df['play_framing']) - 2)

    plt.clf()
    plt.suptitle('')
    plt.title("")
    plt.scatter(df['play_framing'], df['proportion_of_valid_data_last16_idealised'])
    ...
    print("Pearson's r", pearsonr(df['imi_enjoyment'], df['proportion_of_valid_data_last16_idealised'])) 
    print("Spearman's rho", spearmanr(df['imi_enjoyment'], df['proportion_of_valid_data_last16_idealised']))
